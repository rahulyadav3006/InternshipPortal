 ...
 <nav>
    <ul>
        <li><a href="index.php">Home<span class="tab-l"></span><span class="tab-r"></span></a></li>
                <li><a href="fresherpage.php">Fresher Job<span class="tab-l"></span><span class="tab-r"></span></a></li>
                <li><a href="experiencepage.php">Experience Job<span class="tab-l"></span><span class="tab-r"></span></a></li>
...
<form name="reg" action="menuexecute.php" onsubmit="return validateForm()" method="post" id="reg">
    <table>
        <td>
