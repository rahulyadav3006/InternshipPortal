...
<td><input type="password" id="tb-box" name="password" /></td>
</tr>
<tr>
<td class="t-1"><div align="left" id="tb-name">Confirm&nbsp;Password:</div></td>
<td><input type="password" id="tb-box" name="confirm_password" /></td>
</tr>
<tr>
...
<tr>
<td class="t-1"><div align="left" id="tb-name">Join&nbsp;As:</div></td>
<td><select name="user_type" id="tb-box">
